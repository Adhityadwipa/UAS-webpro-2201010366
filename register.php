    ...
    if(isset($_POST['register'])) {
        ...
        if($password == $confirm) {
            ...
            if(!$result->num_rows > 0) {
                $sql = "INSERT INTO tb_user (username, email, password) VALUES ('$username', '$email', '".md5($password)."')";
                $result = mysqli_query($conn, $sql);
                if($result) {
                    echo "<script>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <form class="user" action="register.php" method="POST" autocomplete="off">
                                <div class="buatakun">
                                    <h1 class="h4 text-white-900 mb-5">Buat Akun!</h1>
                                </div>
